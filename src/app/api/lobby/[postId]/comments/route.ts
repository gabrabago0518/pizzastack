...
import { getLobbyCommentsForPost } from "@/lib/queries";
...
// would re-trigger the whole /lobby page's RSC refresh for every expand,
...
export async function GET(
  ...
  const comments = await getLobbyCommentsForPost(postId);
